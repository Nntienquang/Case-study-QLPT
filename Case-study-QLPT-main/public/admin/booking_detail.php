...
<div class="wb-grid wb-stats-4 mb-3">
    <div class="wb-card"><div class="wb-card-label">Booking</div><div class="wb-card-value">#<?php echo (int)($booking['id'] ?? 0); ?></div></div>
    <div class="wb-card"><div class="wb-card-label">Tiền cọc</div><div class="wb-card-value fs-4"><?php echo admin_money($booking['deposit_amount'] ?? 0); ?></div></div>
    <div class="wb-card"><div class="wb-card-label">Check-in</div><div class="wb-card-value fs-4"><?php echo admin_e($booking['checkin_date'] ?? ''); ?></div></div>
...
<div class="wb-card">
    <form method="GET" class="row g-3 align-items-end">
        ...
        <div class="col-md-6">
            ...
            <a href="<?php echo ADMIN_URL . 'bookings.php?action=delete&id=' . (int)($booking['id'] ?? 0); ?>" class="btn btn-outline-danger" onclick="return confirm('Xóa đơn này?');"><i class="fa fa-trash"></i> Xóa đơn</a>
        </div>
    </form>
</div>
