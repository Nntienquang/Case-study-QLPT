...
admin_layout_start('Chi tiáº¿t booking', 'Xem thÃ´ng tin Ä‘áº·t phÃ²ng vÃ  cáº­p nháº­t tráº¡ng thÃ¡i xá»­ lÃ½.', 'bookings');
admin_flash_messages();
?>

<a href="<?php echo ADMIN_URL; ?>bookings.php" class="btn btn-outline-secondary mb-3"><i class="fa fa-arrow-left"></i> Quay láº¡i</a>
...
<div class="wb-grid wb-stats-4 mb-3">
    ...
    <div class="wb-card">
        <div class="wb-card-label">Tiá»n cá»c</div>
    ...
    <div class="wb-card">
        <div class="wb-card-label">Tráº¡ng thÃ¡i</div>
...
<div class="wb-list-card mb-3">
    <div class="wb-list-row">
        <div>
            <div class="wb-title">NgÆ°á»i thuÃª</div>
            <div><?php echo admin_e($booking['user_name'] ?? 'N/A'); ?></div>
            <div class="wb-muted"><?php echo admin_e($booking['user_email'] ?? ''); ?> Â· <?php echo admin_e($booking['user_phone'] ?? ''); ?></div>
        </div>
    </div>
    <div class="wb-list-row">
        <div>
    ...
    <div class="wb-list-row">
        <div>
            <div class="wb-title">NgÃ y táº¡o</div>
...
<div class="wb-card">
    ...
    <form method="POST" class="d-inline" onsubmit="return confirm('XÃ³a Ä‘Æ¡n nÃ y?');">
        ...
        <input type="hidden" name="id" value="<?php echo (int)($booking['id'] ?? 0); ?>">
        <button type="submit" class="btn btn-outline-danger mt-3"><i class="fa fa-trash"></i> XÃ³a Ä‘Æ¡n</button>
    </form>
</div>
