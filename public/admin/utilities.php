...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="<?php echo ADMIN_URL; ?>utilities.php" class="active"><i class="fa fa-wrench"></i> Tiện Nghi</a></li>
        </ul>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="mb-0"><?php echo $action === 'edit' ? 'Cập Nhật Tiện Nghi' : 'Thêm Tiện Nghi Mới'; ?></h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Nhập tên tiện nghi" value="<?php echo htmlspecialchars($edit_utility['name'] ?? ''); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4" style="display: flex; align-items: flex-end;">
                            ...
                            <?php if ($action === 'edit'): ?>
                            <a href="<?php echo ADMIN_URL; ?>utilities.php" class="btn btn-secondary" style="width: 100%; margin-left: 10px;">Hủy</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </form>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Danh Sách Tiện Nghi (<?php echo count($data['utilities']); ?> tiện nghi)</h5>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($utility['name']); ?></td>
                                <td>
                                    <a href="<?php echo ADMIN_URL . 'utilities.php?action=edit&id=' . $utility['id']; ?>" class="btn btn-sm btn-warning">
                                        <i class="fa fa-edit"></i> Sửa
                                    </a>
                                    <a href="<?php echo ADMIN_URL . 'utilities.php?action=delete&id=' . $utility['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Xóa tiện nghi này?');">
                ...
                <?php else: ?>
                <div class="alert alert-info">Không có tiện nghi nào.</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
