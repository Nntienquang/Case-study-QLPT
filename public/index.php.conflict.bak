                ...
                <section>
                    ...
                    <div class="metrics">
                        ...
                        <div class="metric"><strong><?php echo number_format($stats['owners']); ?></strong><span>chủ
                                phòng</span></div>
                        <div class="metric"><strong><?php echo number_format($stats['bookings']); ?></strong><span>đơn
                                đặt phòng</span></div>
            ...
            <div class="container-lg">
                ...
                <div class="feature-grid">
                    <article class="feature-card">
                        ...
                        <h3>Người thuê</h3>
                        <p>Tìm phòng theo khu vực, ngân sách và diện tích; lưu phòng để xem lại, xem chi phí vào ở và
                            đặt lịch xem.</p>
                    </article>
                    <article class="feature-card">
                        <div class="feature-icon"><i class="fas fa-building-user"></i></div>
                        <h3>Chủ phòng</h3>
                        <p>Đăng phòng, nhận lịch xem, theo dõi đơn đặt phòng, chỉnh sửa tin và quản lý doanh thu trong
                            một nơi.</p>
                    </article>
                    <article class="feature-card">
                        ...
                        <div class="room-body">
                            ...
                            <div class="room-tags">
                                ...
                                <?php if (!empty($room['area'])): ?><span
                                    class="room-tag"><?php echo (float)$room['area']; ?> m²</span><?php endif; ?>
                            ...
                            <div class="room-meta mb-3"><i class="fas fa-wallet"></i> Vào ở dự kiến:
                                <?php echo number_format($moveInCost); ?> VNĐ</div>
                            <a href="user/motel-detail.php?id=<?php echo (int)$room['id']; ?>"
                                class="btn-home primary w-100">Xem chi tiết</a>
                        </div>
                    </article>
                    <?php endforeach; ?>
                </div>
...
=======
                    ...
                    <div class="container-lg">
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <h5 class="fw-bold mb-3 text-white">🏠 QuanLyPhongTro</h5>
                                <p class="footer-description">Tìm phòng sạch đẹp, quản lý thuê trọ dễ dàng và minh bạch.
                                    Nền tảng kết nối chủ trọ và người thuê hàng đầu.</p>
                                <div class="social-links mt-3">
                                    <a href="#" class="me-3"><i class="bi bi-facebook"></i></a>
                                    <a href="#" class="me-3"><i class="bi bi-instagram"></i></a>
                                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <h6 class="fw-bold mb-3 text-white text-uppercase small">Liên hệ hệ thống</h6>
                                <p class="footer-info"><i class="bi bi-geo-alt-fill me-2"></i> Trường Đại học Vinh, Nghệ
                                    An</p>
                                <p class="footer-info"><i class="bi bi-envelope-fill me-2"></i> ho-tro@quanlyphongtro.vn
                                </p>
                                <a href="admin/login.php" class="btn btn-light btn-sm fw-bold px-3 mt-2">Quản trị viên
                                    (Admin)</a>
                                >>>>>>> 65a1f305ff724b79096d36304994458c2ba8a525
                            </div>
                        </div>
