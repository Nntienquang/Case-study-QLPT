            ...
            <div class="col-lg-9">
                <div class="main-content">
                    <h1 style="font-size: 28px; font-weight: 700; margin-bottom: 30px;">
                        <i class="fas fa-user"></i> Há»“ SÆ¡ Chá»§ NhÃ 
                    </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="profile-card">
                                ...
                                <div class="info-item">
                                    <div class="info-label"><i class="fas fa-user"></i> Vai TrÃ²</div>
                                    <div class="info-value">Chá»§ NhÃ  / Chá»§ PhÃ²ng Trá»</div>
                                </div>
                                <div class="info-item">
